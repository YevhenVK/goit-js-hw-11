...
},{}],"picture-item.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = pictureItems;

function pictureItems(photo) {
  return photo.map(({
    webformatURL,
    largeImageURL,
    tags,
...
// });
},{}],"button-loadmore.js":[function(require,module,exports) {
"use strict";
...
exports.default = ButtonLoadMore;
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pixabay.js":[function(require,module,exports) {
"use strict";
...
class ImageApi {
  ...
  fetchPicture() {
    ...
    this.page += 1;
    return _axios.default.get(picture);
  }
...
var _pictureItem = _interopRequireDefault(require("./picture-item"));

var _buttonLoadmore = _interopRequireDefault(require("./button-loadmore"));

var _pixabay = _interopRequireDefault(require("./pixabay"));
...
const pixabayItem = new _pixabay.default();
const buttonLoadMore = new _buttonLoadmore.default({
  selector: '.load-more',
  hidden: true
});
...
function addImageList(photos) {
  galleryImages.insertAdjacentHTML('beforeend', (0, _pictureItem.default)(photos));
}
...
function submitForm(event) {
  ...
  if (pixabayItem.query === '') {
    ...
    clearImageList();
    return _notiflix.Notify.info('Nothing has been entered here yet');
  }
...
function fetchPicture(event) {
  buttonLoadMore.hideButton();
  pixabayItem.fetchPicture().then(photos => {
...
function searchTotalHits(totalHits) {
  if (totalHits > 0) {
    return _notiflix.Notify.info(`Hooray! We found ${totalHits} images.`);
  }
}
